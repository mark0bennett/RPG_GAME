...
import rpggame.weapon.SpecialWeapon;
...
//	public static List<Weapon> createListSpecialWeaponsFromCsvFile(String fileName) {
//		String line = "";
//		String splitBy = ",";
//		List<Weapon> readWeaponsList = new ArrayList<>();
//		try {
...
//				}
//
//				Weapon newWeapon = new SpecialWeapon(
//						weapon[0],
//						Integer.parseInt(weapon[1]),
//						Integer.parseInt(weapon[2]),
//						Integer.parseInt(weapon[3]),
//						weaponType,
//						Integer.parseInt(weapon[4]));
//
//				readWeaponsList.add(newWeapon);
//			}
//			bufferedReader.close();
